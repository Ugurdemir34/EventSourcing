...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        public void EditMessage(string message)
        {
            if (_active)
            {
                throw new InvalidOperationException("Your cannot edit the message of an inactive post!");
            }
        ...
        public void LikePost()
        {
            if (_active)
            {
                throw new InvalidOperationException("Your cannot like an inactive post!");
            }
        ...
        public void AddComment(string comment, string userName)
        {
            if (_active)
            {
                throw new InvalidOperationException("Your cannot add a comment to an inactive post");
            }
